...
<!--                            </a>-->
                            <div class="desc"> 
                                ...
                                else if(rs.getString(4).equals("GShoes")) {
                                %>
                                <select id="<%=rs.getString(1)%>">
                                ...
                                else if(rs.getString(4).equals("Dress")) {
                                %>
                                <select id="<%=rs.getString(1)%>">
                                ...
                                else if(rs.getString(4).equals("T-Shirt")|| rs.getString(4).equals("Jacket") || rs.getString(4).equals("Kurta")) {
                                %>
                                <select id="<%=rs.getString(1)%>">
